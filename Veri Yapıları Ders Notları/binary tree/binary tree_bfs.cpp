...
// BFS (Geniþlik Öncelikli Arama)
void BFS(node* agac)
{
    if(agac == NULL)
        return;

    // Kuyruk veri yapýsýný kullanarak düðümleri tutacaðýz
    node* kuyruk[100];
    int bas = 0;
    int son = 0;
...
//BFS algoritmasýný kullanarak düðümleri geniþlik öncelikli olarak dolaþýr. 
