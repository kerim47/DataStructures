...
// DFS - Preorder (Kök - Sol - Sað)
void preOrderDFS(node* agac)
{
    if(agac == NULL)
        return;

    printf("%d ", agac->data);
    preOrderDFS(agac->sol);
    preOrderDFS(agac->sag);
}

// DFS - Inorder (Sol - Kök - Sað)
void inOrderDFS(node* agac)
{
    if(agac == NULL)
        return;
...
// DFS - Postorder (Sol - Sað - Kök)
void postOrderDFS(node* agac)
{
    if(agac == NULL)
        return;

    postOrderDFS(agac->sol);
    postOrderDFS(agac->sag);
    printf("%d ", agac->data);
}

//Preorder, Kök-Sol-Sað 
//Inorder Sol-Kök-Sað 
//Postorder Sol-Sað-Kök
